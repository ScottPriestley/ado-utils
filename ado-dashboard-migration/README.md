...
Four ordered PowerShell entry scripts export team dashboards, recreate referenced Shared Queries, import dashboards, and optionally repair only the Area/Iteration nodes referenced by exported WIQL.
